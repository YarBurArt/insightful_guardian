...
if __name__ == "__main__":
    #check_count_by_model("This restaurant is awesom arse-bandits and\
    ...
    #task = acreate([{"role":"user", "content":"Please rate the aggression level of \
        # the following text on a scale of 1 (minimum) to 9 (maximum) ( only use a number in your answer):"}, 
